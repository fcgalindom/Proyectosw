      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <form method="post" style="text-align:right"> 
              <input style="width: 17%;font-family: monospace;"type="text" placeholder="Filtrar por estudiante" name="xnombre"/>
...
top: -10px; font-family: monospace;'>Filtrar</button>
            ...
            <div style="top: 5%;     text-align: center;" class="card">
              <div style="text-align-last: center;" class="card-header">
                ...
                <h3 style="font-variant: all-petite-caps; font-family: monospace; font-size: 20px;     display: contents;"  class="card-title">OFERTAS EN PROCESO</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table style="font-family: monospace;" id="example2" class="table table-bordered table-hover">
                  ...
                  $sql= "SELECT Oe.cod_oferta, 
                                E.nom_estudiante, Et.nom_estado
                       FROM OFERTA_ESTUDIANTE Oe
                       INNER JOIN ESTUDIANTE E ON Oe.cod_estudiante = E.cod_estudiante
                       INNER JOIN ESTADO Et ON Oe.cod_estado = Et.cod_estado $where $limit";
                  ...
                  ?>
                    ...
                    <th><?php echo $mostrar['nom_estado'] ?></th>              
                  </tr>
                  </tbody>                  
                <?php
                } 
