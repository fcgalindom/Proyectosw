        ...
        <table >
              <tr ALING="center">
                    <td    style = ' padding-left: 900px'>
                      <button style="font-family: monospace;" type="button" class="btn btn-block btn-info" onclick="location.href='libPDF/pdfInforme1.php'" style='width:150px; height:40px;  background-color: #0B7984; border-color: #0B7984'>Generar Informe</button>
                    </td>
          ...
          <div class="col-12">
            <div class="card">
              <div style="text-align-last: center;" class="card-header">
                <h3 style="font-variant: all-petite-caps; font-family: monospace; font-size: 20px;     display: contents;"  class="card-title">Cantidad de estudiantes aplicantes por empresa</h3>
              </div>
              ...
              <div class="card-body" style="text-align: center;">
                ...
                GROUP BY(nom_empresa);";
                  ...
                  {  
                  ?>
                    <th><?php echo $mostrar['nombre_empresa'] ?></th>
                    <th><?php echo $mostrar['cantidad_aplicantes'] ?></th>
