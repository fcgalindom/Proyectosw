        ...
        <table >
              <tr ALING="center">
                    <td    style = ' padding-left: 900px'>
                      <button type="button" class="btn btn-block btn-info" onclick="location.href='libPDF/pdfInforme5empresas.php'" style='    font-family: monospace; width:150px; height:40px;  background-color: #0B7984; border-color: #0B7984'>Generar Informe</button>
                    </td>
          ...
          <div class="col-12">
            <div class="card">
              <div style="text-align-last: center;" class="card-header">
                <h3 style="font-variant: all-petite-caps; font-family: monospace; font-size: 20px;     display: contents;" class="card-title">Cantidad de ingresos por empresa</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table style="text-align-last: center; font-family: monospace;" id="example2" class="table table-bordered table-hover">
                  ...
                  ?>
                    ...
                    <th><?php echo $mostrar['ingresos_empresas'] ?></th>                
                  </tr>
                  </tbody>                  
                <?php
                } 
