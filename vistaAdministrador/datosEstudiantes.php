...
<div class="wrapper">
  ...
  <div class="content-wrapper">
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <form method="post" style="text-align:right"> 
              <input style="width: 17%;font-family: monospace;" type="text" placeholder="Filtrar por nombre" name="xnombre"/>
    ...
    width: 83px;
    height: 40px;
    border-color: #0B7984;     margin-left: 17%;
    position: absolute;
    top: -10px; font-family: monospace;'>Filtrar</button>
            ...
            <div class="card" style="top: 5%;     text-align: center;">
            
              <div style="text-align-last: center;" class="card-header">

              
                <h3 style="font-variant: all-petite-caps; font-family: monospace; font-size: 20px;     display: contents;" class="card-title">ESTUDIANTES</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table style="font-family: monospace;" id="example2" class="table table-bordered table-hover">
                  ...
                  if(isset($_POST['buscar']))
                  {
                    if(empty($_POST['']))
                    {
                         $where="WHERE nom_estudiante like '".$nombre."%'";
                    }
                  }                
                  
                  $sql= "SELECT E.cod_estudiante, E.nom_estudiante, E.telefono, E.correo, E.direccion, E.lim_oferta, E.contrasenia,
                  C.nom_carrera
                  FROM ESTUDIANTE E
                  INNER JOIN CARRERA C ON E.cod_carrera = C.cod_carrera $where $limit";
                  $resultado=mysqli_query($conexion,$sql);

                  while($mostrar=mysqli_fetch_array($resultado)) 
                  {  
                  ?>
                    <th><?php echo $mostrar['cod_estudiante'] ?></th>
                    <th><?php echo $mostrar['nom_estudiante'] ?></th>
                    <th><?php echo $mostrar['telefono'] ?></th>
                    <th><?php echo $mostrar['correo'] ?></th>
                    <th><?php echo $mostrar['direccion'] ?></th>

                    <th><?php echo $mostrar['lim_oferta'] ?></th>
                    <th><?php echo $mostrar['contrasenia'] ?></th>
                    <th><?php echo $mostrar['nom_carrera'] ?></th>   
