        ...
        <table >
              <tr ALING="center">
                    <td    style = ' padding-left: 900px'>
                      <button style="font-family: monospace;" type="button" class="btn btn-block btn-info" onclick="location.href='libPDF/pdfInforme3.php'" style='background-color: #0B7984; border-color: #0B7984; width:150px; height:40px'>Generar Informe</button>
                    </td>
          ...
          <div class="col-12">
            <div class="card">
              <div style="text-align-last: center;" class="card-header">
                <h3 style="font-variant: all-petite-caps; font-family: monospace; font-size: 20px;  display: contents;"  class="card-title">Cantidad de postulaciones por estudiante</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body" style="text-align: center;">
                <table style="font-family: monospace;" id="example2" class="table table-bordered table-hover">
                  ...
                  ?>
                    ...
                    <th><?php echo $mostrar['cantidad_postulaciones'] ?></th>                
                  </tr>
                  </tbody>                  
                <?php
                } 
