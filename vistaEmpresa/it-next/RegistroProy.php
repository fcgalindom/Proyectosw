                            ...
                            <div class="col-md-9 col-lg-8 mx-auto">
                               <center> <h3 class="login-heading mb-4">Registrarse</h3></center>
                                <form action="..\..\controladorEmpresa\insertarEmpresa.php" method="post"   enctype="multipart/form-data">
                                    ...
                                    <br>
                                    <div class="form-label-group">
                                        <input type="password" id="password" name="password" class="form-control" placeholder="password" placeholder="password" required autofocus>
                                        
                                    </div>
                                    <br>
                                    
                                    <div class="form-label-group">
                                        <input  type="password" id="confirmarPassword" name="confirmarPassword" class="form-control" placeholder="confirmarPassword" required autofocus>
