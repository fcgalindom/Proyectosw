...
-- Tiempo de generación: 16-09-2020 a las 03:34:57
...
(6, 'EMPRESA', 'ACTUALIZAR', '2020-09-15'),
(7, 'EMPRESA', 'ACTUALIZAR', '2020-09-15');
...
CREATE TABLE IF NOT EXISTS `carrera` (
  ...
  `nom_carrera` varchar(30) DEFAULT NULL,
...
(1, 'das', 'dasd', 'dsadasd', 1, '1', '../dataEmpresa/logoEmpresa/feriaop_bd.sql', 'fe@gmail.com', '7110eda4d09e062aa5e4a390b0a572ac0d2c0220', 1, 'Vigente', 1),
(2, 'Pepsi', 'PP', 'Alternativa de cocacola', 4, '1', 'ruta', 'Pepsi@gmail.com', '1234', 1, 'Vigente', 1);
...
INSERT INTO `estudiante` (`cod_estudiante`, `nom_estudiante`, `telefono`, `correo`, `direccion`, `lim_oferta`, `contrasenia`, `cod_carrera`, `tipo_usuario`, `semestre`) VALUES
(1, 'Daniel Chimbi', '3166271527', 'dachimbil@unbosque.edu.co', 'Cra 73 #71a-29', 2, '123456', 1, NULL, NULL);
